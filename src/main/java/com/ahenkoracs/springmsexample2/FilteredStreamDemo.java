...
public class FilteredStreamDemo {
    ...
    private static String bearerToken = "AAAAAAAAAAAAAAAAAAAAAJvGuAEAAAAAISaVTstxuGQaeLXSOnUyZCfgUaw%3D8kIhBjH3l9yXy7rGoGs822jXpJ0FKWeKf5FEZGi985TqiorsLH";
        ...
        if (null != entity) {
            ...
            if (json.length() > 1) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    System.out.println("No value for JSON data");
                }
            }
        }
        return rules;
